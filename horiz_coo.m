...
%            (Long & Lat) | (Az & Alt) in radians long=RA in rad lat=dec in
%            rad
...
elseif (nargin==4),
   ...
   error('eran:horiz_coo','Ilegal number of input arguments');
end
...
LST=lst(JD,TopoPos(:,1),'m'); % given as a fraction of a 24h
...
elseif (Direction=='e'),
   ...
   error('eran:horiz_coo','Ilegal type of conversion');
end
